...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#001E38] py-8 px-4 mt-20 text-white">
      <div className="w-11/12 mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div>
          <Link to="/" className="text-2xl font-extrabold flex items-center gap-2">
            <span className="bg-yellow-300 text-[#001E38] px-2 py-1 rounded">BookCourier</span>
          </Link>

          <p className="text-gray-300 mt-3 text-sm">
            Library to home delivery
          </p>

          <ul className="space-y-2 mt-4 text-gray-200">
            <li>
              <Link to="/books" className="hover:text-yellow-300">All Books</Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-200">
            <li>
              <Link to="/help" className="hover:text-yellow-300">Help Center</Link>
            </li>
            <li>
              <Link to="/how-it-works" className="hover:text-yellow-300">How It Works</Link>
            </li>
            <li>
              <Link to="/pricing" className="hover:text-yellow-300">Pricing Policy</Link>
            </li>
            <li>
              <Link to="/coverage" className="hover:text-yellow-300">Coverage Map</Link>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-200">
            ...
            <li>
              <Link to="/wishlist" className="hover:text-yellow-300">My Wishlist</Link>
            </li>
            <li>
              <Link to="/contact" className="hover:text-yellow-300">Report an Issue</Link>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="border-t border-blue-300 mt-8 pt-4">
        <div className="w-full flex flex-col md:flex-row justify-center items-center text-center gap-3">
          <p className="text-sm text-gray-200">© {currentYear} BookCourier. All Rights Reserved.</p>

          <div className="hidden md:flex items-center text-sm text-gray-200">
            <Link to="/privacy" className="hover:text-yellow-300 mr-3">Privacy Policy</Link>
            <Link to="/terms" className="hover:text-yellow-300">Terms of Service</Link>
          </div>
        </div>
      </div>
